...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 6a - Octágono", nullptr, nullptr);
	if (!window) {
	...
	int nPoints = 8; // Octágono: 8 lados
	...
	while (!glfwWindowShouldClose(window)) {
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0) {
				...
				char tmp[256];
				sprintf(tmp, "Exercicio 6a - Octágono\tFPS %.2lf", fps);
