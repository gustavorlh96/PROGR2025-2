...
* Lista 1 - Exercicio 6b - Pentágono
* Aluno: Gustavo Haag
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 6b - Pentágono", nullptr, nullptr);
	if (!window) {
	...
	int nPoints = 5; // Pentágono: 5 lados
	...
	while (!glfwWindowShouldClose(window)) {
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0) {
				...
				char tmp[256];
				sprintf(tmp, "Exercicio 6b - Pentágono\tFPS %.2lf", fps);
