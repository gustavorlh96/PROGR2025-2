...
* Lista 2 - Exercicio 1 - Modificar a janela do mundo
* Aluno: Gustavo Haag
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 1 - Modificar a janela do mundo", nullptr, nullptr);
	if (!window) {
	...
	while (!glfwWindowShouldClose(window)) {
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0) {
				...
				char tmp[256];
				sprintf(tmp, "Exercicio 1 - Modificar a janela do mundo\tFPS %.2lf", fps);
